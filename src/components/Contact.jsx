...
const socialLinks = [
  {
    href: 'https://github.com/Dhruvil965',
  ...
  {
    href: 'https://www.linkedin.com/in/dhruvil-patel-189a7724b/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/dhruvil3694/',
  ...
  return (
    ...
    className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                ">
                    {socialLinks.map(({href,icon},key) => (
                        <a href={href} key={key} className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80" target="_blank">
                            {icon}
                        </a>
                    ))}
                </div>
            ...
            <form 
            action="https://getform.io/f/azyqnpxb" 
            method="POST"
            className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        id="email"
                        name="email"
                        placeholder="DhruvilPatel@example.com"
                        required
                        autoComplete="email"
                        className="text-field"
                        />
